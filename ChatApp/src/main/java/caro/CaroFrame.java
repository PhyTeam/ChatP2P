...
public class CaroFrame extends JFrame implements ActionListener {
	...
	private String playerName1 = "Ngư�?i chơi 1", playerName2 = "Ngư�?i chơi 2";
	...
	private PeerMethodController controller = new PeerMethodController();
	
	public CaroFrame(PeerService service) {
		init();
		// Init connect
	...
	private JPanel createPanelStatus(boolean player) {
		...
		if (player) {
			...
			lbNamePlayerX = new JLabel("Ngư�?i chơi 1");
			...
			lbNamePlayerO = new JLabel("Ngư�?i chơi 2");
